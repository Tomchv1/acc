 ...
 */
final class Version20210128084130 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE adhesion (id INT AUTO_INCREMENT NOT NULL, annee_id INT DEFAULT NULL, banque VARCHAR(60) DEFAULT NULL, montant_total DOUBLE PRECISION DEFAULT NULL, montant_cb DOUBLE PRECISION DEFAULT NULL, montant_sepa DOUBLE PRECISION DEFAULT NULL, montant_ancv DOUBLE PRECISION DEFAULT NULL, montant_can DOUBLE PRECISION DEFAULT NULL, montant_cheque DOUBLE PRECISION DEFAULT NULL, montant_autre DOUBLE PRECISION DEFAULT NULL, commentaire LONGTEXT DEFAULT NULL, INDEX IDX_C50CA65A543EC5F0 (annee_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
